...
plotname = 'throughput/multi-plots/pacing-direct-t249000-250000.png'
...
def read_file(n1_file_name, filter_port):
    ...
    n1_df['time_between_packets'] = n1_df['elaps_time_us'].diff()
...
# plt.plot(opera_df['elaps_time_us'], opera_df['time_between_packets'], label = "opera", marker='|')
plt.plot(direct_df['elaps_time_us'], direct_df['time_between_packets'], label = "direct", marker='|')
...
plt.ylabel('Time between packets (us)', fontsize=11)
