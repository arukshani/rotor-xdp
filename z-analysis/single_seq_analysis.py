...
n1_df = read_file("1-direct-node-1.csv")
n1_df = n1_df.loc[(n1_df['slot'] == 0)]
n1_df = n1_df.loc[(n1_df['is_fin'] != 1)]
# n1_df = n1_df.loc[(n1_df['ns_packet_len'] == 3414)]
# print(n1_df.head(15))
...
plt.savefig('data/seq/1-seq-direct-all.png')
